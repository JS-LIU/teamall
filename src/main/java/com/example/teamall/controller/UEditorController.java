...
//            uploadedStream.close();
    ...
    public void uploadToFarService(String fileName,byte[] body_data) throws ClientProtocolException, IOException {
        byte[] byt = new byte[1024];
        InputStream inputStream = new ByteArrayInputStream(body_data);
//        ByteArrayBody byteArrayBody = new ByteArrayBody(body_data,"image_name");
//
...
//                .addPart("file2",byteArrayBody).build();
        ...
        HttpPost httpPost = new HttpPost("http://123.57.161.212:9936/imageserver/upload");
